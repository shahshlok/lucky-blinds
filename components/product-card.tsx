...
export function ProductCard({ product, onQuickLook }: ProductCardProps) {
  return (
    ...
    >
      ...
      {/* Product Info - Updated label from materials to features */}
