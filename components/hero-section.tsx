...
export function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-[100svh] min-h-[700px] overflow-hidden">
        ...
        <div className="container-luxe">
          <div className="max-w-4xl">
            ...
            >
              ...
              From sun-drenched mornings to vineyard sunsets.
            </motion.p>
        ...
        <div className="relative">
          <div className="w-24 h-24 border border-[#C4785A]/40 rounded-full flex items-center justify-center">
            <div className="text-center">
              <span className="block text-2xl font-display text-[#FAF7F2]">15+</span>
              <span className="block text-[10px] uppercase tracking-[0.15em] text-[#FAF7F2]/70">Years</span>
            </div>
          </div>
        </div>
      </motion.div>
