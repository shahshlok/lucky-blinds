    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="absolute inset-0 bg-gradient-to-tr from-[#8A9A5B]/20 via-transparent to-transparent" />
            ...
            {/* Side Accent Line */}
            <motion.div
                className="hidden lg:block absolute left-8 top-1/2 -translate-y-1/2 w-[1px] h-32 bg-gradient-to-b from-transparent via-[#8A9A5B] to-transparent z-20"
                ...
                <div className="container-luxe">
                    <div className="max-w-4xl">
                        ...
                        >
                            <motion.a
                                href="#contact"
                                className="group inline-flex items-center gap-3 px-8 py-4 bg-[#8A9A5B] text-[#FAF7F2] text-sm font-medium uppercase tracking-[0.1em] transition-all duration-500 hover:bg-[#6F7D48]"
