        ...
        >
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden mb-5">
                ...
                >
                  ...
                  <motion.div 
                    className="absolute inset-0 bg-[#8A9A5B]/0 group-hover:bg-[#8A9A5B]/10 transition-colors duration-500"
                  />
                </motion.div>
              ...
              <div className="space-y-1">
                <h3 className="font-display text-2xl text-[#FAF7F2] group-hover:text-[#8A9A5B] transition-colors duration-300">
                  {collection.name}
                </h3>
          ...
          >
            <div className="text-center p-8 border border-[#FAF7F2]/20 h-full flex flex-col items-center justify-center">
              <span className="text-[#8A9A5B] text-6xl font-display mb-4">+</span>
              ...
              <motion.a
                href="#contact"
                className="px-6 py-3 border border-[#8A9A5B] text-[#8A9A5B] text-sm uppercase tracking-wider font-medium hover:bg-[#8A9A5B] hover:text-[#FAF7F2] transition-all duration-300"
